...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (subcommand === 'pause') {
      ...
      if (!minutes || minutes <= 0) minutes = config.defaultPauseTime;
      haikuHelpers.pause(interaction, minutes, true);
    }

    else if (subcommand === 'unpause') {
      haikuHelpers.unpause(interaction, true);
    }
      ...
      haikuHelpers.count(interaction, syllPhrase.split(' '));
    }
